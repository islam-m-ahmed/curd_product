...
<header>
    ...
    <br>
    <h1  class=" text-center py-3 my-3">add product</h1>
    ...
    <form action="<?php url('product/store') ?>" method="post" name="">
            <div class="form-goup">
            ...
            <div class="form-group">
                ...
                <input type="number" value="" name="product_price" placeholder="500" class="form-control" required>
            </div>
            <div class="form-group">
                <label>&nbsp; Quantity <span>*</span></label required>
                <input type="number" value="" min="1" name="product_quntity" class="form-control" required>
            </div>
            <div class="form-group">
                <label>&nbsp; Discount <span>*</span></label required>
                <input id="last_input" type="number" value="" name="product_discount" placeholder="%" class="form-control" required>
            </div>
            <div class="container">
